                        ...
                        return (
                            <div key={pegawai.id} className="slip-container">
                                ...
                                <div>
                                    ...
                                    {/* 2. TABEL UTAMA */}
                                    <table className="w-full border-collapse border border-black text-center text-[9.5px] mb-0.5 leading-tight">
                                                ...
                                                pegawai.detail_harian.map((hari: DetailHarian, idx: number) => {
                                                    ...
                                                    return (
                                                        <tr key={idx} className="border-b border-black">
                                                            ...
                                                            <td className="py-0.2 font-bold text-right px-1 text-[9.5px]">{formatAngka(totalHarianKalkulasi)}</td>
                                                        </tr>
                                                    );
                                                })
                                            ) : (
                                ...
                                {/* 3. FOOTER */}
                                <div className="flex justify-between items-start text-[9.5px] leading-tight">

                                    {/* Kiri: Info Tabungan & Hutang */}
                                    <table className="border border-black text-left w-[47%]">
                                        <tbody>
                                            <tr><td colSpan={2} className="py-0.2 px-1 border-b border-black bg-gray-100 font-bold text-center text-[9.5px]">KASBON & TABUNGAN</td></tr>
                                    ...
                                    <table className="text-right w-[51%] border border-black">
                                        <tbody>
                                            ...
                                            <tr className="bg-gray-200 font-black text-[10px]">
                                                <td className="py-0.5 pr-1 border-r border-black uppercase">UPAH BERSIH</td>
                                                <td className="py-0.5 px-1 text-gray-900 font-black text-[10.5px]">{formatAngka(pegawai.total_upah)}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
