                    ...
                    <div className="flex flex-wrap items-center gap-2.5 w-full sm:w-auto">
                        ...
                        <div className="relative flex-1 sm:flex-none">
                            <select
                                ...
                                className={`w-full sm:min-w-[150px] border border-slate-300 rounded-xl px-3 py-1.5 text-xs font-medium outline-none focus:ring-2 focus:ring-red-500/20 focus:border-red-500 shadow-2xs transition-all ${!filterDepartemen
                    ...
                    <div className="flex items-center gap-2 flex-wrap sm:flex-nowrap">
                        ...
                        <div className="bg-slate-200/80 p-1 rounded-xl flex items-center gap-1 shadow-inner">
                            <button
                                ...
                                className={`px-3 py-1.5 rounded-lg text-xs font-semibold transition-all cursor-pointer ${periode === 'minggu'
                            ...
                            <button
                                ...
                                className={`px-3 py-1.5 rounded-lg text-xs font-semibold transition-all cursor-pointer ${periode === 'bulan'
                                    ? 'bg-white text-slate-800 shadow-xs'
                                    : 'text-slate-600 hover:text-slate-900'
                                    }`}
                            >
                            ...
                            <button
                                ...
                                className={`px-3 py-1.5 rounded-lg text-xs font-semibold transition-all cursor-pointer ${periode === 'tahun'
                                    ? 'bg-white text-slate-800 shadow-xs'
                                    : 'text-slate-600 hover:text-slate-900'
                                    }`}
                            >
